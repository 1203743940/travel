...
<!-- banner-bottom-slider -->
	...
	<br>
					<ul class="pagination pagination-lg">
						<li><a href="SearchView?search=<%= search %>&page=<%= page1-1%>"><i class="fa fa-angle-left">&laquo;</i></a></li>
						<li><a href="SearchView?search=<%= search %>&page=1">1</a></li>
						<li><a href="SearchView?search=<%= search %>&page=2">2</a></li>
						<li><a href="SearchView?search=<%= search %>&page=3">3</a></li>
						<li><a href="SearchView?search=<%= search %>&page=4">4</a></li>
						<li><a href="SearchView?search=<%= search %>&page=5">5</a></li>
						<li><a href="SearchView?search=<%= search %>&page=<%= page1+1%>"><i class="fa fa-angle-right">&raquo;</i></a></li>
					</ul>
					<br>
	<br>
	</div>
