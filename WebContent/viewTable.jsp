...
String kind =(String)request.getAttribute("search");
searchSonList=(List<Scenery>)request.getAttribute("searchSonList"); 
...
<!-- banner-bottom-slider -->
	...
	<br>
					<ul class="pagination pagination-lg">
						<li><a href="kindScenery?kind=<%= kind %>&page=<%= page1-1%>"><i class="fa fa-angle-left">&laquo;</i></a></li>
						<li><a href="kindScenery?kind=<%= kind %>&page=1">1</a></li>
						<li><a href="kindScenery?kind=<%= kind %>&page=2">2</a></li>
						<li><a href="kindScenery?kind=<%= kind %>&page=3">3</a></li>
						<li><a href="kindScenery?kind=<%= kind %>&page=4">4</a></li>
						<li><a href="kindScenery?kind=<%= kind %>&page=5">5</a></li>
						<li><a href="kindScenery?kind=<%= kind %>&page=<%= page1+1%>"><i class="fa fa-angle-right">&raquo;</i></a></li>
					</ul>
					<br>
	<br>
	</div>
