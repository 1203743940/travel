	...
	<nav class="gtco-nav" role="navigation">
		<div class="gtco-container">
			...
			<div class="row">
				...
				<div id="gtco-logo"><a href="login.jsp">Login <em>.</em></a></div>
					
				</div>
				<div class="col-xs-8 text-right menu-1">
					<ul>
						
						<li class="btn-cta"><a href="../Recommend"><span>Walk</span></a></li>
					</ul>
				</div>
			</div>
		...
		<div class="gtco-container">
			<div class="row">
				<div class="col-md-12">
					...
					<form id="info" action="../Info?userId=<%= user.getUser_id() %>" method="post">
						<div class="row form-group">
							<div class="col-md-12">
								<label class="sr-only" for="name">Name</label>
								<input type="text" id="name" name="name" class="form-control" placeholder="请输入你的名字">
							</div>
							
						</div>
						<div class="row form-group">
							<div class="col-md-12">
								<label class="sr-only" for="sex">Subject</label>
						...
						<div class="row form-group">
							<div class="col-md-12">
								<label class="sr-only" for="birth">Email</label>
								出生日期：&nbsp;&nbsp;&nbsp;&nbsp;<input type="date" id="birth" name="birth" class="form-control" placeholder="Your Birthday">
							</div>
						</div>
						...
						<div class="row form-group">
							<div class="col-md-12">
								...
								地址：<select  id="province" name="province"  onchange="selectprovince(this);" style=" width:95px;"></select>
        ...
        for(var i =0;i<list2element.length; i++)
        {
            ...
            ddlCity.appendChild(option);
						...
						<div class="row form-group">
							<div class="col-md-12">
								<label class="sr-only" for="subject">Subject</label>
								<input type="text" id="phone" name="phone" class="form-control" placeholder="请输入你的手机号码">
							</div>
						</div>
						...
						<div class="row form-group">
							<div class="col-md-12">
								<label class="sr-only" for="subject">Subject</label>
								<input type="password" id="passwordNew" name="passwordNew" class="form-control" placeholder="请输入你的新密码">
							</div>
						</div>
						...
						<!-- <div class="row form-group">
							<div class="col-md-12">
								<label class="sr-only" for="subject">Subject</label>
								<input type="password" id="passNewA" name="passNewA" class="form-control" placeholder="请输再次确认你的密码">
							</div>
						</div> -->

						
						<div class="form-group">
							<input type="submit" value="确认更改" class="btn btn-primary">
						</div>
...
<script>  
    ...
    var check = function(){  
        if (userId==null){//验证出错的情况just a demo  
            return false;
            alert{"请先登陆"};
